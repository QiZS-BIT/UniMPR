...
if __name__ == '__main__':
    dataroot = '/home/octane17/UniMPR/data/nusc/info'
    nuscenes_root = '/media/octane17/T7ShieldNus/NuScenes'
    if not os.path.exists(dataroot):
        os.makedirs(dataroot)
    if not os.path.exists(os.path.join(dataroot[:-5], 'index')):
        os.makedirs(os.path.join(dataroot[:-5], 'index'))
    if not os.path.exists(os.path.join(dataroot[:-5], 'bev')):
        os.makedirs(os.path.join(dataroot[:-5], 'bev'))
