...
from dataset.Boreas.boreas_dataset import QueryDataset
...
def make_dataloader(working_mode, params: ModelParamsFull):
    if working_mode == 'train':
        ...
        test_dataset = QueryDataset(
            params.boreas_param.info_root,
            params.boreas_param.bev_dataset_root,
            params.boreas_param.database_index_list,
            params.boreas_param.test_query_index_list,
            params.boreas_param.gth_dist_threshold,
            params.boreas_param.pos_rot_threshold,
